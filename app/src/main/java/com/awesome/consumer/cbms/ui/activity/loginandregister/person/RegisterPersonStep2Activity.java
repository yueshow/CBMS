 ...
 * -----------------------------------------------------------------
 */
public class RegisterPersonStep2Activity extends BaseActivity implements View.OnClickListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.register_person_step2);
/*
    ...
    public void onClick(View v) {
        startActivity(new Intent(this, RegisterPersonStep3Activity.class));
    }
}
